...
const About = () => {
  return (
    <div id="about" className="mt-24 flex flex-col md:flex-row w-full h-screen bg-amber-800">
      ...
      <div className="w-full md:w-1/2 p-4 md:p-8 bg-gray-100 flex items-center justify-center">
        <div className="text-center md:text-left">
          ...
          Our hair stylists have years of experience and a passion for creating
        beautiful hairstyles. 
            <br/>
            <br/>
            We stay up to date with the latest trends and
        techniques to ensure you receive the best service. Visit us today and
